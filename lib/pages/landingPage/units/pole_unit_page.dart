...
class PoleUnitPage extends StatelessWidget {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: isSmallScreen
                      ? Column(
                          children: [
                            buildCourseInfoSection(context, isSmallScreen),
                            const SizedBox(height: 20),
                            buildInfoContainer(context, isSmallScreen),
                          ],
                        )
                      : Row(
  ...
  Widget buildCourseInfoSection(BuildContext context, bool isSmallScreen) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
  ...
  Widget buildInfoContainer(BuildContext context, bool isSmallScreen) {
    return Container(
      width: isSmallScreen
